    ...
    >
      ...
      <section className="relative h-[88vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          {/* The visible hero heading rotates with the slideshow, so the page's
              stable h1 lives here for screen readers and search engines. */}
          <h1 className="sr-only">
            Akiko's Buddhist Bed & Breakfast — a meditation, yoga and nature
            retreat in Hakalau on the Hamakua Coast of Hawaii
          </h1>
