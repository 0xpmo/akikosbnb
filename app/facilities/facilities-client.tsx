...
import { GROUNDS_GALLERY, GROUNDS_IMAGE_SRCS } from "@/lib/grounds-gallery";
      ...
      images: [
        {
          ...
          alt: "The main yoga studio room with wooden floors and exposed beam ceiling at Akiko's Buddhist B&B in Hakalau, Hawaii",
        },
        {
          src: "/facilities/yoga-studio/yoga-altar.webp",
          alt: "Altar area inside the yoga studio, used for restorative yoga and tai chi practice",
        },
        {
          src: "/facilities/yoga-studio/yoga-teacher-area.webp",
          alt: "Teaching area of the yoga studio looking out toward the tropical gardens",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "Interior of the zendo meditation hall used for zazen at Akiko's Buddhist B&B on the Hamakua Coast",
        },
        {
          src: "/facilities/zendo/altar.webp",
          alt: "Buddhist altar in the zendo meditation hall",
        },
        {
          src: "/facilities/zendo/inside-altar.webp",
          alt: "Close view of the zendo altar with offerings and incense",
        },
        {
          src: "/facilities/zendo/wall-blocks.webp",
          alt: "Wooden wall detail inside the zendo meditation hall",
        },
        {
          src: "/facilities/zendo/zendo-outside-rotated.jpg",
          alt: "Exterior of the zendo surrounded by tropical plants in Hakalau, Hawaii",
        },
      ],
    },
  ];

  /** Resolves the alt text for whichever image the lightbox is showing. */
  const altForImage = (src: string) =>
    [...facilities.flatMap((facility) => facility.images), ...GROUNDS_GALLERY].find(
      (image) => image.src === src
    )?.alt ?? "Akiko's Buddhist B&B in Hakalau, Hawaii";
    ...
    >
      ...
      >
        <div className="container mx-auto px-4 py-1 flex items-center justify-between">
          ...
          >
            ...
            />
            <div>
              <p className="font-['Yuji_Boku'] text-xl font-semibold text-white">
                Buddhist B&B
              </p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-['Yuji_Boku'] text-5xl font-light mb-6 text-foreground drop-shadow-sm">
            Sacred Amenities
          </h1>
          <p className="text-xl text-foreground max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
            ...
            spiritual practice — a zendo for zazen, a yoga studio, and two acres
            of tropical gardens in Hakalau on the Hamakua Coast of Hawaii. Each
            facility is thoughtfully created to support your journey of inner
            peace and awakening.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {facility.images.map((image, imageIndex) => (
                    ...
                    >
                      <div className="h-64 lg:h-80 bg-muted rounded-xl group-hover:scale-105 transition-transform duration-300 shadow-lg group-hover:shadow-xl relative overflow-hidden">
                        <Image
                          src={image.src}
                          alt={image.alt}
                          fill
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {GROUNDS_GALLERY.map((image, index) => (
                <div
                  key={image.src}
                  className="group cursor-pointer"
                  onClick={() => {
                    ...
                    setCurrentFacilityImages([...GROUNDS_IMAGE_SRCS]);
                  }}
                >
                  {/* Rendered as a real <img> rather than a CSS background so
                      the photos are visible to Google Images. */}
                  <div className="h-48 lg:h-56 bg-muted rounded-xl group-hover:scale-105 transition-transform duration-300 shadow-lg group-hover:shadow-xl relative overflow-hidden">
                    <Image
                      src={image.src}
                      alt={image.alt}
                      fill
        ...
        {/* Footer */}
        <SiteFooter className="border-t border-white/20" />
      </section>
