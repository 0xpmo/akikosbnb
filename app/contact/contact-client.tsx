...
export default function Contact() {
  ...
  // Prefill the accommodation from ?accommodation=... after mount.
  //
  // This used to call useSearchParams() during render inside a <Suspense>
  // boundary that wrapped the whole page, which forced Next to skip
  // prerendering all of it — the static HTML for /contact was just a loading
  // spinner, so crawlers saw an empty page. Reading the query string here
  // keeps the page fully static.
  useEffect(() => {
    const accommodation = new URLSearchParams(window.location.search).get(
      "accommodation"
    );
    if (accommodation) {
    ...
    >
      ...
      >
        <div className="container mx-auto px-4 max-w-4xl">
          <h1 className="font-['Yuji_Boku'] text-4xl font-light text-center mb-12 text-foreground">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <address className="not-italic text-muted-foreground">
                      ...
                      Hakalau, HI 96710
                      <br />
                      Hamakua Coast · 15 miles north of Hilo
                    </address>
                  </div>
                </div>
                <div className="mt-6">
